...
@Component({
  selector: 'app-lost-city',
  templateUrl: './lost-city.component.html',
  styleUrls: ['./lost-city.component.css']
})
export class LostCityComponent {
...
// view the review
  ...
  lost:string ="https://m.media-amazon.com/images/I/91SLGwV-bqL.jpg";
}
